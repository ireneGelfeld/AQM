...
#######################PARAMS#########################################
JobLength=0;#Minimal Job Length to display                           #
PanelNumber = 1;#Panel number for calculating Mean,STD,sum    
DistBetweenSets =  102693  #102693 Duplex Drop3 = 125864,   Duplex-Drop5 126357
...
# def max_minSetS(StdataAllColors):
#     C2CMinMax=pd.DataFrame()
#     for c in StdataAllColors.columns:
#         C2CMinMax[c]=[np.max(StdataAllColors[c])-np.min(StdataAllColors[c])];
#     return C2CMinMax;       
...
St1dataAllColorsFrontLeft,St2dataAllColorsFrontLeft,St3dataAllColorsFrontLeft,indexNumberFailed=CalcC2C(pthF+'/',side,fname,JobLength,LoadTarget).CalcC2CSingleSidePerSetDEFULTvalue()
...
St1dataAllColorsFrontRight,St2dataAllColorsFrontRight,St3dataAllColorsFrontRight,indexNumberFailed=CalcC2C(pthF+'/',side,fname,JobLength,LoadTarget).CalcC2CSingleSidePerSetDEFULTvalue()
# 
...
try:
    side='Back';
    fname='Registration_Left.csv'
    St1dataAllColorsBackLeft,St2dataAllColorsBackLeft,St3dataAllColorsBackLeft,indexNumberFailed=CalcC2C(pthF+'/',side,fname,JobLength,LoadTarget).CalcC2CSingleSidePerSet()
        
    side='Back';
    fname='Registration_Right.csv'
    St1dataAllColorsBackRight,St2dataAllColorsBackRight,St3dataAllColorsBackRight,indexNumberFailed=CalcC2C(pthF+'/',side,fname,JobLength,LoadTarget).CalcC2CSingleSidePerSet()
